...
## تحديث v3
- تم إضافة تسجيل خروج واضح من الإعدادات مع رسالة تأكيد.
- تم إضافة تسجيل خروج من القائمة الجانبية مع منع الرجوع للصفحات الداخلية بعد الخروج.
- يتم حذف حالة الجلسة من SharedPreferences ويعود المستخدم إلى شاشة Login.

## ملاحظة رفع GitHub
إذا لم يظهر فولدر `.github` أو `assets` عند الرفع بالسحب، ارفع الملفات العادية فقط، ثم أنشئ يدويًا:
- `.github/workflows/build-release-apk.yml`
- `assets/images/logo_placeholder.txt`

## تحديث v4 - إصلاح تسجيل الخروج
- تم تقوية زر تسجيل الخروج في الإعدادات والقائمة الجانبية.
- يتم مسح حالة الجلسة من SharedPreferences بأكثر من مفتاح احتياطي.
- يتم نقل المستخدم إلى شاشة تسجيل الدخول باستخدام root navigator.
- تم إضافة AuthGate لمنع فتح الصفحات الداخلية بعد تسجيل الخروج أو بزر الرجوع.
